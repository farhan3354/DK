...
const App = () => {
  return (
    ...
    <Routes>
      ...
      <Route path='social-swiril'element={<Loja/>} />
      <Route path='social-swiril'element={<Goloritu/>} />
      <Route path='social-swiril'element={<Elisha/>} />
      <Route path='social-swiril'element={<Dk/>} />
    </Routes>
    <Footer/>
    </BrowserRouter>
  )

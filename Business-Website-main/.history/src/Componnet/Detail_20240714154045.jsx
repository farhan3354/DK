      ...
      <div className="p-4" style={{ width: '60%' }}>
        ...
        <div className="flex flex-col items-center text-black">
          ...
          <p className="text-center mb-4">
            Token Harvest: Unleash Daily Gains from Idle Assets.<br/> Earn daily rewards effortlessly as your idle tokens work for you with unmatched efficiency. Embrace the power of passive income with our innovative platform, maximizing your earnings while you relax.
          </p>

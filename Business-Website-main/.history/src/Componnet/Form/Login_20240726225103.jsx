...
const Login = () => {
  return (
    <div className="pl-96 bg-gradient-to-b from-yellow-100 via-white to-yellow-100 min-h-screen">
    <form className="form  border-4 border-yellow-500 rounded-xl pt-18 pb-8  bg-yellow-500">

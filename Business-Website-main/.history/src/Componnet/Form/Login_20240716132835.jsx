...
const Login = () => {
    ...
    return (
        <div className="flex justify-center items-start p-10 space-x-10 bg-gradient-to-b from-yellow-100 via-white to-yellow-100 p">
           <div className="flex flex-col items-center text-center mb-12">
           <h1 className="text-5xl font-bold text-yellow-500 m-5">LogI</h1>
           </div>

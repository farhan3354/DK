      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          {cards.map((card) => (
            <div
              key={card.id}
              className="w-32 h-32 sm:w-44 sm:h-44 md:w-56 md:h-56 bg-gradient-to-r from-yellow-600 via-yellow-200 to-white flex justify-center items-center transform transition-transform duration-500 cursor-pointer hover:scale-105 hover:shadow-lg"

...
const TreeCard = ({ title, content }) => {
  return (
    <div className="w-60 p-6 bg-gray-100 border border-gray-300 rounded-lg shadow-md text-center">
    ...
    <div className="flex flex-col items-center">
      ...
      <div className="flex justify-center items-end mb-16">
        <div className="flex flex-col items-center mx-12">
          ...
          <div className="border-l border-gray-300 h-22 mt-3"></div>
        </div>
        <div className="flex flex-col items-center mx-12">
          <TreeCard title="Child 2" content="Child Node 2" />
          <div className="border-l border-gray-300 h-16 mt-3"></div>
        </div>
      </div>

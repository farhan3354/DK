...
const Tree = () => {
  ...
  <div className="flex justify-center items-end mb-10">
      ...
      <div className="flex justify-center items-end mb-16">
        ...
        <div className=' mr-24 '>
        <div className="flex flex-col items-center  ">
          <TreeCard title="Great-Grandchild 2" content="Great-Grandchild Node 2 Great-Grandchild Node 2Great-Grandchild Node 2Great-Grandchild Node 2Great-GranGreat-Grandchild Node 2Great-Grandchild Node 2Great-Grandchild Node 2Great-Grandchild Node 2Great-Grandchild Node 2Great-Grandchild Node 2dchild Node 2Great-Grandchild Node 2Great-Grandchild Node 2" />
        </div>
        </div>
      </div>

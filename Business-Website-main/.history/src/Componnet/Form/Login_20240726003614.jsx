...
const Login= () => {
  return (
    <div className="tree-container">
      ...
      <div>
        <img className='h-48 w-screen'
        src="https://www.shutterstock.com/shutterstock/photos/1379435369/display_1500/stock-vector-falling-coins-falling-money-flying-gold-coins-golden-rain-jackpot-or-success-concept-modern-1379435369.jpg" alt="" />
      </div>
    </div>
  );
};

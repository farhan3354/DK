...
const SignUp = () => {
  ...
  return (
    <div className="bg-yellow-500 min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="max-w-lg w-full bg-gray-600 p-8 rounded-2xl">
        <h2 className="text-4xl font-bold mb-6 text-center">Sign Up</h2>
        <form onSubmit={handleSubmit}>
          <div className="flex mb-4">
            <div className="w-1/2 mr-2">
              <label className="block text-sm font-medium text-yellow-500">First Name</label>
              <input
                type="text"
                name="firstName"
            ...
            <div className="w-1/2 ml-2">
              <label className="block text-sm font-medium text-yellow-500">Last Name</label>
              <input
                type="text"
                name="lastName"
          ...
          <div className="flex mb-4">
            <div className="w-1/2 mr-2">
              <label className="block text-sm font-medium text-yellow-500">New Password</label>
              <input
                type="password"
                name="newPassword"
            ...
            <div className="w-1/2 ml-2">
              <label className="block text-sm font-medium text-yellow-500">Confirm Password</label>
              <input
                type="password"
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium text-yellow-500">Location</label>
            <select
              name="location"
          ...
          <div className="mb-6 flex items-center">
            <input
              ...
              required
            />
            <label className="ml-2 text-sm text-yellow-500">Are you a robot?</label>
          </div>
          <button
            type="submit"

      ...
      <div className="absolute inset-0 flex justify-center items-center">
        <div className="grid grid-cols-4 gap-8">
          {cards.map((card) => (
            <div
              key={card.id}
              className="w-52 h-52 bg-yellow-800 flex justify-center items-center transform transition-transform duration-300 cursor-pointer"
            ...
            >
              <div
                ...
                style={{
                  transform: 'rotateX(30deg) rotateY(-50deg) translateZ(30px)', // Increased rotation and depth

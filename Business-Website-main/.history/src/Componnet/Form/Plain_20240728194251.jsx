...
const Plain = () => {
  ...
  const cardDataArray = [
    { title: 'Student Plan', tableData: [[1000, 2000], [1000, 2000]] },
    { title: 'Dk Share', tableData: [[3000, 4000], [3000, 4000]] },
    { title: 'Golden Plans', tableData: [[5000, 6000], [5000, 6000]] },
    { title: 'Sharing Plan', tableData: [[7000, 8000], [7000, 8000]] },
    { title: 'Real Estate', tableData: [[9000, 10000], [9000, 10000]] },
    { title: 'Car Financed', tableData: [[11000, 12000], [11000, 12000]] },
    { title: 'One Million Plan', tableData: [[13000, 14000], [13000, 14000]] },
    { title: 'Stock Market Plan', tableData: [[15000, 16000], [15000, 16000]] },
  ];

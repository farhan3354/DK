...
const Tree = () => {
  return (
    <div className="flex flex-col items-center bg-cover bg-center p-10" style={{ backgroundImage: "url('https://ae01.alicdn.com/kf/HTB1BT3KhLiSBuNkSnhJq6zDcpXaV/2pcs-set-Manzanita-Dry-Artificial-Fake-Foliage-Plant-Tree-Branch-Wedding-Home-Church-Office-Furniture-Green.jpg')" }}>
      {/* Root */}
      <div className="mb-16">
      ...
      <div className="flex justify-center items-end mb-16">
        <div className="flex flex-col items-center mx-12">
          ...
          <div className="border-l border-gray-300 h-50 mt-12"></div>
        </div>
        <div className="flex flex-col items-center mx-12">

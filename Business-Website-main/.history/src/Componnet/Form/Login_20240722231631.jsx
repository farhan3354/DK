...
const Projects = () => {
  return (
    <div
      ...
      style={{ backgroundImage: 'url("https://dkgroup.pk/wp-content/up024/03/investment-tree-811x1024.png")' }}
    >
      <div className="absolute top-0 left-0 w-full h-full p-4 flex flex-col items-center">
        ...
        {/* Second row */}
        <div className=" flex justify-between mb-6 max-w-xl">
          <div className="p-4 bg-white border border-gray-300 rounded-lg shadow-lg w-60 h-40">
            <img
              src={projects[1].src}
              alt={`Project 2`}
        ...
        {/* Third row */}
        <div className="w-full flex justify-between mb-6 max-w-2xl ">
          <div className="p-4 bg-white border border-gray-300 rounded-lg shadow-lg w-60 h-40">
            <img
              src={projects[3].src}
              alt={`Project 4`}

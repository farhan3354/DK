    ...
    <div className="bg-gradient-to-b from-yellow-100 via-white to-yellow-100 min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-yellow-500 p-8 rounded-lg shadow-md max-w-lg w-full">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-black text-white py-2 px-4 rounded-md shadow-sm hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
            Sign Up
          </button>
        </form>

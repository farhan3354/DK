...
const Plain = () => {
  ...
  const containerStyle = {
    ...
    backgroundSize: 'h-300vh', // Ensures the image covers the container
    backgroundPosition: 'center',
    backgroundRepeat: 'no-repeat',
    /* /* height: '200vh', // Adjust this value to increase the height of the container
    width: '100%', */
  }; 

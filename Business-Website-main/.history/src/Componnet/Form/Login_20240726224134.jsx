...
const Login = () => {
  return (
    <form className="form  border-4 border-yellow-500 rounded-xl mb-8 ml-96 bg-yellow-500">
      ...
      <div className="flex-row">
        ...
        <button className="btn apple">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.773 22.773" width="200" height="20">

...
const Plain = () => {
  ...
  return (
    <div className="px-4 py-6"> {/* Apply padding around the entire component */}
      <div className="relative z-10">
        <h1 className="font-bold text-yellow-500 text-7xl text-center mt-10 mb-10">Our Plans</h1>
        <div className="grid grid-cols-1 gap-4 mb-4 ml-0 md:ml-16 lg:ml-80">
          <Card cardData={cardDataArray[0]} onClick={handleOpenModal} />
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-4 ml-8 md:ml-32">
          <Card cardData={cardDataArray[1]} onClick={handleOpenModal} />
          <Card cardData={cardDataArray[2]} onClick={handleOpenModal} />
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-6 ml-0 md:ml-32">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 ml-8 md:ml-32">

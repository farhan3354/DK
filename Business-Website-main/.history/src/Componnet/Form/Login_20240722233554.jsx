...
const Projects = () => {
  return (
    <div
      className="relative w-full h-full py-10 px-4 bg-cover bg-center"
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            {projects.slice(1, 3).map((project, index) => (
              <div key={index} className="p-6 bg-white border border-gray-300 rounded-lg shadow-lg flex flex-col items-center justify-center">

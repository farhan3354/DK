...
import p1 from '../../assets/Backgroundimg.png';
...
const Plain = () => {
  ...
  const backgroundImageStyle = {
    ...
    backgroundSize: 'cover', // Adjust this value to increase/decrease the size of the image
    backgroundPosition: 'center',  
    backgroundRepeat: 'no-repeat',
    height: '100vh', // Make sure the container is full height

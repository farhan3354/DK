...
const Modal = ({ isVisible, content, onClose }) => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      className="fixed inset-0 z-50 flex justify-center items-center overflow-hidden bg-yellow-500 bg-opacity-50"
    >
      <div className="relative bg-white rounded-lg shadow dark:bg-gray-700 max-w-md w-full p-4">
        ...
        <div className="p-4">
          <table className="min-w-full border bg-yellow-300 border-black">
            <tbody>

...
const SignUp = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-yellow-100 via-white to-yellow-100 min-h-screen border-4 border-yellow-500 rounded-xl flex items-center justify-center">

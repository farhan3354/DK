          ...
          <div className="flex mb-4">
            <div className="w-1/2 mr-2">
              ...
              <input
                ...
                className="mt-1 block w-full p-3 border border-black  bg-blue-500 rounded-2xl shadow-2xl focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"

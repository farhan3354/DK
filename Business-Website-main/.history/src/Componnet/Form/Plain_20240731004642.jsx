...
const Plain = () => {
  ...
  const cards = [
    { id: 1, label: 'Student Plan',text:"In our investment Journey Dk provide handsome Opporitiently  to our young telent to invest and earn attractive  pocket expenisve " },
    { id: 2, label: 'Card 2' },
    { id: 3, label: 'Card 3' },
    { id: 4, label: 'Card 4' },
    { id: 5, label: 'Card 5' },

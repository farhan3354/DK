...
const SignUp = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-yellow-100 via-white to-yellow-100 min-h-screen flex items-center justify-center">
      <div className="max-w-lg w-full  rounded-2xl border-4 border-yellow-500 bg-white m-10">

      ...
      <div className="absolute inset-0 flex justify-center items-center">
        <div className="grid grid-cols-4 gap-8">
          {cards.map((card) => (
            <div
              key={card.id}
              className="w-56 h-52 bg-yellow-800 flex justify-center items-center cursor-pointer transform transition-transform duration-500 hover:scale-105 hover:shadow-lg"
              ...
              style={{
                ...
                transform: 'rotateX(0deg) rotateY(0deg)', // Default rotation for 3D effect

    ...
    <footer className="bg-black text-white py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between">
        ...
        <div className="flex items-center ml-4"> {/* Added ml-4 for left margin */}
          <div className="text-center text-white bg-bg-inherit m-2 rounded-xl pr-12 border-2 border-white bg-grey"> {/* Added border-2, rounded-xl, and border-white classes */}

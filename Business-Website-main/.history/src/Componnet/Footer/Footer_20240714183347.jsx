      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-wrap justify-between">
        ...
        <div className="mx-12">
          ...
          <nav className="space-y-3 flex flex-col">
            ...
            <a href="/projects" className="text-white hover:text-yellow-500">Projects</a>
            <a href="/pricing" className="text-white hover:text-yellow-500">Pricing</a>
            <a href="/our-story" className="text-white hover:text-yellow-500">Our Story</a>
            <a href="/contact" className="text-white hover:text-yellow-500">Contact Us</a>
          </nav>
        </div>

        {/* Join Section */}
        <div className="mx-12 my-4 py-4 bg-bg-inherit rounded-xl text-center text-white flex flex-col items-center justify-center">

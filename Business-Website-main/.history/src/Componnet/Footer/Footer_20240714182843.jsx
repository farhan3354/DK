  ...
  return (
    <footer className="bg-black text-white py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className=' text-center text-white py-4  bg-bg-inherit m-2 border-collapse rounded-xl'>
        <h1>JOIN OUR OF INVESTOR TODAY</h1>
           DK Group insightful strategies and commitment to <br/> client success have transformed my portfolio, <br/>earning both trust and impressive returns.
           <br/>

  ...
  return (
    <footer className="bg-black text-white py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between">
        ...
        {/* Join Section */}
        <div className="flex flex-col items-center sm:flex-row sm:items-center ml-4 bg-greay-900">
          <div className="text-center text-white bg-bg-inherit m-2 rounded-xl pr-12 border-2 border-yellow-500 p-3 hover:border-white">

...
<div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2  gap-6 mx-4 sm:mx-10 lg:mx-48 mt-10 mb-10'>
  <Link to='http://localhost:5173/' className='transform transition duration-300 hover:scale-105'>
    <div className='bg-yellow-500 border rounded-2xl shadow-2xl p-4 pt-6 pb-6'>
      <h1 className='font-bold text-2xl flex items-center mb-3'>
  ...
  <Link to='http://localhost:5173/projects' className='transform transition duration-300 hover:scale-105'>
    <div className='bg-yellow-500 border rounded-2xl shadow-2xl p-4 p-4 pt-6 pb-6'>
      <h1 className='font-bold text-2xl flex items-center mb-3'>
  ...
  <Link to='http://localhost:5173/contact' className='transform transition duration-300 hover:scale-105'>
    <div className='bg-yellow-500 border rounded-2xl shadow-8xl p-4 pt-6 pb-6'>
      <h1 className='font-bold text-2xl flex items-center mb-3'>

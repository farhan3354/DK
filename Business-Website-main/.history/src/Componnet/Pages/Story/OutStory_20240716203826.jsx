    ...
    <div className='bg-gradient-to-b from-yellow-100 via-white to-yellow-100 p-4 md:p-12'>
      ...
      <div>
        <div>
          ...
          <p className='font-sm'>At DK Group, our mission is to empower individuals by strategically <br/>multiplying their investments across diverse projects and various<br/> digital assets. We believe in the transformative power of strategic<br/> investments, aiming not only to generate wealth but to do so with <br/>integrity, security, and purpose. Our commitment extends beyond<br/> profits; we are dedicated to creating opportunities for our clients <br/>and communities alike.

            Through our innovative approach, we <br/>strive to provide monthly returns on investments, ensuring a <br/>steady income stream for our clients. Our focus on diversity, both in projects and digital assets, allows us to mitigate risks and maximize returns. With a dedication to excellence and a vision for social impact, we invite you to join us in rewriting the story of success through responsible investing.</p>
        </div>
      </div>
    </div>
  )

  ...
  return (
    <div className='bg-white p-4 md:p-12'>
      ...
      <div className=" ml-56">
        ...
        <p className='m-5'>
          DK Group is driven by a commitment to excellence, transparency, and community empowerment, ensuring sustainable growth and positive<br /> impact globally.</p>
      </div>

      <div className='flex flex-wrap space-x-7 items-center justify-center m-10'>
      <Link to='/home' className='transform transition duration-300 hover:scale-105 w-full sm:w-auto'>
        <div className='bg-yellow-500 border rounded-2xl shadow-2xl pl-12 p-4 mb-6 sm:mb-0'>
      ...
      <Link to='/project' className='transform transition duration-300 hover:scale-105 w-full sm:w-auto'>
        <div className='bg-yellow-500 border rounded-2xl shadow-2xl pl-12 p-4 mb-6 sm:mb-0'>
          <h1 className='font-bold text-2xl m-3'>
      ...
      <Link to='/plans' className='transform transition duration-300 hover:scale-105 w-full sm:w-auto'>
        <div className='bg-yellow-500 border rounded-2xl shadow-2xl pl-12 p-4 mb-6 sm:mb-0'>
          <h1 className='font-bold text-2xl m-3'>
      ...
      <Link to='/contact' className='transform transition duration-300 hover:scale-105 w-full sm:w-auto'>
        <div className='bg-yellow-500 border rounded-2xl shadow-2xl pl-12 p-4 mb-6 sm:mb-0'>
          <h1 className='font-bold text-2xl m-3'>

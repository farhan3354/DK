...
const OutStory = () => {
  return (
    <div className='bg-white p-4 md:p-12'>
      ...
      <Link to='/home' className='transform transition duration-300 hover:scale-105'>
      ...
      <Link to='/project' className='transform transition duration-300 hover:scale-105'>
      ...
      <Link to='/contact' className='transform transition duration-300 hover:scale-105'>
        <div className='bg-yellow-500 border rounded-2xl shadow-2xl pl-12 p-4'>
          <h1 className='font-bold text-2xl m-3'>

  ...
  return (
    <div className='bg-gradient-to-b from-yellow-100 via-white to-yellow-100 p-4 md:p-12'>
      ...
      <div className="flex justify-center  items-center">
        ...
        <p className='m-5'>
          DK Group is driven by a commitment to <br/>excellence, transparency, and<br/> community empowerment, ensuring sustainable growth and positive<br/> impact globally.</p>
      </div>

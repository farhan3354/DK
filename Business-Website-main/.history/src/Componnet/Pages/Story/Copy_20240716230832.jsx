                        ...
                        .map((project, index) => (
                            <div key={index} className="rounded-lg overflow-hidden shadow-lg bg-yellow-400">
                                ...
                                <div className="p-5 text-center bg-yellow-300">
                                    ...
                                    <button className="bg-yellow-500 text-white py-2 px-4 rounded-2xl hover:bg-green-600 focus:outline-none focus:bg-green-600 mt-4 transition duration-300">View Profile</button>
                                </div>
                            </div>
                        ))}
                </div>

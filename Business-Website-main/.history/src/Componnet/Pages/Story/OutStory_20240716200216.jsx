  ...
  return (
    <div className='bg-gradient-to-b from-yellow-100 via-white to-yellow-100 p-4 md:p-12'>
      ...
      <div className="flex justify-center  items-center">
        ...
        <div>
        <h1 className='font-semibold text-2xl '>Open source</h1>
        <p>Open source
        DK Group operates as an open-source platform, fostering collaboration<br/> and innovation within its community-focused initiatives.</p>

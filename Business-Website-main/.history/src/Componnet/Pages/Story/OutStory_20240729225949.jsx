...
const OutStory = () => {
  ...
  <h1 className="font-bold text-xl sm:text-2xl lg:text-3xl my-4 sm:my-8 text-center sm:text-left sm:ml-52">
    What drives DK Group?
  </h1>
  <p className="sm:text-lg mr-32 lg:text-xl text-center mx-2 sm:mx-4 lg:mx-8">

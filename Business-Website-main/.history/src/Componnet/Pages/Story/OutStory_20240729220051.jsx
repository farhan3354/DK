...
const OutStory = () => {
  return (
    <div className='bg-white p-4 md:p-12'>
      ...
      <div className=" px-4 sm:px-6 lg:px-8 ml-44">
  <h1 className='font-bold text-xl sm:text-2xl lg:text-3xl ml-10   my-4 sm:my-8'>
    What drives Dk Group?
  </h1>
  <p className='text-base sm:text-lg lg:text-xl text-center mx-2 sm:mx-4 lg:mx-8'>
  DK Group is driven by a commitment to excellence, transparency, and community empowerment, ensuring sustainable growth and positive<br /> 
  impact globally.
</p>

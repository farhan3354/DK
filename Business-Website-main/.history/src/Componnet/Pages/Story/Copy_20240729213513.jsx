        ...
        <div className="">
            <div className="container mx-auto px-4 md:px-24 m-16">
                <div className="m-12 mx-36">
                    <h2 className="text-4xl font-bold text-black">Our Legend</h2>
                    <p className="text-lg text-gray-700 mt-2">A passionate legend committed to delivering excellence.</p>
                </div>
                <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    {projects
                        .slice(currentSet * slidesPerPage, (currentSet + 1) * slidesPerPage)
                        .map((project, index) => (
                            <div key={index} className="rounded-lg overflow-hidden shadow-lg bg-yellow-400">
                                ...
                                <div className="p-5 text-center bg-yellow-300">
                                    ...
                                    <button className="bg-black text-white py-2 px-4 rounded-2xl hover:bg-green-600 focus:outline-none focus:bg-green-600 mt-4 transition duration-300">View Profile</button>
                                </div>
                            </div>
                        ))}
                </div>

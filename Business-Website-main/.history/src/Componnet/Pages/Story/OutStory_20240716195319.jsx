    ...
    <div className='flex flex-col items-center bg-gradient-to-b from-yellow-100 via-white to-yellow-100 p-4 md:p-12'>
      ...
      <div className="flex justify-center">
        ...
        <p>
          ...
          DK Group is driven by a commitment to excellence, <br/>transparency, and community empowerment, ensuring sustainable<br/> growth and positive impact globally.</p>
      </div>

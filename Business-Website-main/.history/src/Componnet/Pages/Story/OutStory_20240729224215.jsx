...
const OutStory = () => {
  ...
  <Link to='http://localhost:5173/' className='transform transition duration-300 hover:scale-105 w-full sm:w-auto'>
  ...
  <Link to='http://localhost:5173/projects' className='transform transition duration-300 hover:scale-105 w-full sm:w-auto'>
  ...
  <Link to='/plans' className='transform transition duration-300 hover:scale-105 w-full sm:w-auto'>
    <div className='bg-yellow-500 border rounded-2xl shadow-2xl pl-12 p-4 m-6 mx-0'>
      <h1 className='font-bold text-2xl m-3'>
  ...
  <Link to='http://localhost:5173/contact' className='transform transition duration-300 hover:scale-105 w-full sm:w-auto'>
    <div className='bg-yellow-500 border rounded-2xl shadow-2xl pl-12 p-4'>
      <h1 className='font-bold text-2xl m-3'>

  ...
  return (
    <div className='bg-gradient-to-b from-yellow-100 via-white to-yellow-100 p-4 md:p-12'>
      ...
      <div className="flex justify-center  items-center">
        ...
        <p className='pl-8'>Open source
        DK Group operates as an open-source platform,<br/> fostering collaboration and innovation within<br/></br.> its community-focused initiatives.</p>

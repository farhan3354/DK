...
const OutStory = () => {
  ...
  <h1 className='font-bold text-xl sm:text-2xl lg:text-3xl ml-52 my-4 sm:my-8'>
    What drives Dk Group?
  </h1>
  <p className='text-base ml-52 sm:text-lg lg:text-xl text-center mx-2 sm:mx-4 lg:mx-8'>

...
import { FontAwesomeIcon } from 'react-icons/fi';
import { faPhoneVolume, faEnvelope } from 'react-icons/fi';
        ...
        <div className="flex justify-center items-start m-10 space-x-10">
            ...
            <div className="flex flex-col justify-center items-start w-2/1 text-left space-y-4 m-28">
                ...
                <p className="text-black">
                    Connect with us to explore investment opportunities tailored to your needs and goals.
                </p>

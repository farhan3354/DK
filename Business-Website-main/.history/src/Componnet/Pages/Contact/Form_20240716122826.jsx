...
import 'fortawesome/css/all.min.css';
    ...
    return (
        <div className="flex justify-center items-start m-10 space-x-10">
            ...
            <div className="flex flex-col justify-center items-start w-2/1 text-left space-y-4 m-28">
                ...
                <p className="text-black pl-8">
                    <i className="fas fa-phone-alt mr-2"></i>+92 3064257447
                </p>
                <p className="text-black pl-8">
                    <i className="fas fa-envelope mr-2"></i>info@dkgroup.pk
                </p>
            </div>
        </div>
    );

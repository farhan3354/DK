  ...
  return (
    <div className="flex justify-center items-start m-10 space-x-10">
        ...
        <div className="flex mb-4 space-x-4">
          <div className="w-1/2">
            ...
            <input
              ...
              className="shadow appearance-none border rounded-md w-full py-3 px-3 text-white bg-yellow-400 leading-tight focus:outline-none focus:shadow-outline"
      ...
      <div className="flex flex-col justify-center items-start w-2/1 text-left space-y-4 m-10">
        ...
        <p className="text-black pl-8 ">+92 3064257447</p>
        <p className="text-black pl-8">info@dkgroup.pk</p>
      </div>
    </div>
  );
};

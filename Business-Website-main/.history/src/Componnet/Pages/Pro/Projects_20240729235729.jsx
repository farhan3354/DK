...
const projects = [
  {
    ...
    title: "Dk",
    star: "★ ★ ★ ★ ☆",
    text: "“Our recruitment services go beyond matching skills to jobs; we connect businesses with talent that aligns with their culture and goals, ensuring mutual success andgrowthInvestors in DK Recruitment benefit from the

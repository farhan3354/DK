...
const projects = [
  ...
  },
  {
    ...
    learnMoreLink: "/social-swirl-learn-more",
    planLink: "/social-swirl-plan",
  }
];
      ...
      {index % 2 === 0 ? (
        <>
          ...
          <div className='flex flex-col '>
            ...
            <div className='flex space-x-4 mt-2'>
              <a href={project.learnMoreLink} className='bg-yellow-500 text-white p-2 pl-6 pr-6 mt-3 ml-24 rounded'>Learn More</a>
              <a href={project.planLink} className='bg-yellow-500 text-white p-2 pl-6 pr-6 mt-3 rounded'>Plan</a>
            </div>
          </div>
        </>
      ) : (
        <>
          <div className='flex flex-col '>
            ...
            <p className='text-md'>{project.text}</p>
            <div className='flex space-x-4 mt-2'>
              <a href={project.learnMoreLink} className='bg-yellow-500 text-white p-2 pl-6 pr-6 mt-2 rounded ml-24'>Learn More</a>
              <a href={project.planLink} className='bg-yellow-500 text-white p-2 pl-6 pr-6 mt-2 rounded'>Plan</a>
            </div>
          </div>
  ...
  return (
    <div className='bg-white to-yellow-100 flex justify-center items-center'>
      <div className='text-center max-w-4xl flex flex-col items-center'>
        ...
        <h1 className='text-yellow-500 text-3xl font-bold m-5 mt-2 mb-3'>Our Projects</h1>

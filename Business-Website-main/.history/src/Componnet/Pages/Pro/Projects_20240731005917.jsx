      ...
      {index % 2 === 0 ? (
        <>
          ...
          <div className='flex flex-col '>
            ...
            <div className='flex space-x-4 mt-2'>
              <a href={project.learnMoreLink} className='bg-yellow-500 text-white p-2 pl-6 pr-6 mt-3 ml-24 rounded-xl'>Learn More</a>
              <a href={project.planLink} className='bg-yellow-500 text-white p-2 pl-10 pr-10 mt-3 rounded-xl'>Plan</a>
            </div>
          </div>
        </>
      ) : (
        <>
          <div className='flex flex-col '>
            ...
            <p className='text-md'>{project.text}</p>
            <div className='flex space-x-4 mt-2'>
              <a href={project.learnMoreLink} className='bg-yellow-500 text-white p-2 pl-6 pr-6 mt-2 rounded-xl ml-24'>Learn More</a>
              <a href={project.planLink} className='bg-yellow-500 text-white p-2 pl-10 pr-10 mt-2 rounded-xl'>Plan</a>
            </div>
          </div>

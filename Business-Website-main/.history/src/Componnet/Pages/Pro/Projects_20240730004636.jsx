      ...
      {index % 2 === 0 ? (
        <>
          ...
          <div className='flex flex-col '>
            ...
            <div className='flex space-x-4 mt-2'>
              <button className='bg-yellow-500 text-white p-2 pl-6 pr-6 mt-3 ml-24 rounded'>Learn More</button>
              <button className='bg-yellow-500 text-white p-2 pl-6 pr-6 mt-3 rounded'>Plan</button>
            </div>
          </div>
        </>
      ) : (
        <>
          <div className='flex flex-col '>
            ...
            <p className='text-md'>{project.text}</p>
            <div className='flex space-x-4 mt-2'>
              <button className='bg-yellow-500 text-white p-2 pl-6 pr-6 mt-2 rounded ml-24'>
                <a href='/'>Learn More</a>
                </button>
              <button className='bg-yellow-500 text-white p-2 pl-6 pr-6 mt-2 rounded'>
                <a href='/'>Plan</a>
                </button>
            </div>
          </div>

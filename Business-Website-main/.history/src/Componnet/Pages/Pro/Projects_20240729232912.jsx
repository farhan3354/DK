    ...
    <div className='bg-white to-yellow-100 flex justify-center items-center'>
      <div className='text-center max-w-4xl flex flex-col items-center'>
        ...
        <div className='relative mb-5 w-full flex justify-center'>
          <input
            type='text'
            className='border-2 border-yellow-500 rounded-full p-3 pl-10 w-2/3 focus:outline-none focus:border-yellow-600'
            placeholder='Search Projects...'
            value={searchQuery}
            onChange={handleSearch}
          />
          <FaSearch className='absolute left-10 top-3 text-yellow-500' />
        </div>

        ...
        <>
          ...
          <div className='flex flex-col '>
            ...
            <div className='flex gap-8'>
              ...
              <button className='bg-yellow-500 text-white p-2 pl-6 pr-6 mt-3 rounded'>Button 2</button>
            </div>
          </div>
        </>
      ) : (
        <>
          <div className='flex flex-col '>
            ...
            <div className='flex space-x-4 mt-2'>
              <button className='bg-yellow-500 text-white p-2 pl-6 pr-6 mt-2 rounded ml-24'>Button 1</button>
              <button className='bg-yellow-500 text-white p-2 pl-6 pr-6 mt-2 rounded'>Button 2</button>
            </div>
          </div>

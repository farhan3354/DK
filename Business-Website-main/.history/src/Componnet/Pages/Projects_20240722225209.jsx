...
const projects = [
  {
    ...
    alt: "Project Image",
    text: "Our recruitment services go beyond matching skills to jobs; we connect businesses with talent that aligns with their culture and goals, ensuring mutual success and growth."
  },
  {
    src: "https://dkgroup.pk/wp-content/uploads/2024/03/Untitled-3-1024x580.png",
    alt: "Project Image",
    text: "Investors in DK Recruitment benefit from the growth of human capital, as our recruitment services connect businesses with the right talent, generating returns through the strategic placement of skilled professionals."
  },
  {
    src: "https://dkgroup.pk/wp-content/uploads/2024/03/Untitled-6-1024x580.png",
    alt: "Project Image",
    text: "Our recruitment services align talent with business culture, ensuring success and growth for both."
  },
  {
    src: "https://dkgroup.pk/wp-content/uploads/2024/03/Untitled-4-1024x580.png",
    alt: "Project Image",
    text: "We connect businesses with the right talent, fostering mutual growth and generating returns through strategic placement."
  },
  {
    src: "https://dkgroup.pk/wp-content/uploads/2024/03/Untitled-5-1024x580.png",
    alt: "Project Image",
    text: "Our services enhance human capital growth, benefiting investors through effective talent placement."
  }
];
        ...
        <div className="flex flex-col items-center justify-center m-4">
          ...
          <div className="flex justify-center items-center mt-3">
            <img
              ...
              src="https://dkgroup.pk/wp-content/uploads/2024/03/investment-tree-811x1024.png"
              alt="Investment Tree"
            />
          </div>
        </div>

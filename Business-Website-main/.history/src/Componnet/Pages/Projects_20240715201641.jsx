  ...
  return (
    <div className='bg-gradient-to-b from-yellow-100 via-white to-yellow-100  flex justify-center items-center'>
      <div className='text-center max-w-4xl flex flex-col items-center'>
        <h1 className='text-4xl font-bold m-4 text-yellow-500'>Project</h1>
        ...
        <h1 className='text-yellow-500 text-5xl font-bold m-5'>Our Projects</h1>
        ...
        <div className="flex flex-col items-center justify-center m-4">
            <h1 className="font-bold text-2xl text-right mt-3 mb-3 mr-10">Plans</h1>

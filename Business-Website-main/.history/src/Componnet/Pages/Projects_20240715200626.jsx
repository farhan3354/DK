  ...
  return (
    <div className='bg-gradient-to-b from-yellow-100 via-white to-yellow-100  flex justify-center items-center'>
      <div className='text-center max-w-4xl flex flex-col items-center'>
        ...
        <h1 className='font-bold text-2xl text-center mt-10 mb-10'>Plans</h1> 
        <div className="flex justify-center items-center m-3">
            <img className="w-full h-auto" src="https://dkgroup.pk/wp-content/uploads/2024/03/investment-tree-811x1024.png" alt="Investment Tree" />
        </div>
      </div>
    </div>
  );

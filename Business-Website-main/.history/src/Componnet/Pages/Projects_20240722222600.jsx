  ...
  return (
    <div className='bg-gradient-to-b from-yellow-100 via-white to-yellow-100 flex justify-center items-center'>
      <div className='text-center max-w-4xl flex flex-col items-center'>
        <motion.h1 
          className='text-5xl font-bold m-4 text-yellow-500'
        ...
        <motion.h1 
          className='text-yellow-500 text-3xl font-bold m-5'
          initial={{ opacity: 0, y: -50 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        {/* Repeat the motion.div structure for other project sections */}
        <motion.div 

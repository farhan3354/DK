...
const Pricing = () => {
  ...
  <div className="flex max-w-3xl mx-auto">
    <div className="flex-1">
      <div className="bg-yellow-500 text-white rounded-lg shadow-md p-6 mb-6 <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-yellow-100 via-white to-yellow-100">
  <div className="flex max-w-3xl mx-auto">
    <div className="flex-1">

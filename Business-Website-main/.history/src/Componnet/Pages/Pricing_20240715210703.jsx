  ...
  return (
    <div className='flex items-center justify-center bg-gradient-to-b from-yellow-100 via-white to-yellow-100'>
      ...
      <div>
        ...
        https://dkgroup.pk/wp-content/uploads/2024/03/div-2.png  Trading Charts
        https://dkgroup.pk/wp-content/uploads/2024/03/div-3.png   Wallet
        https://dkgroup.pk/wp-content/uploads/2024/03/div-4.png   Real Time Trading
        all four img and text in online
      </div>
    </div>
  );
};

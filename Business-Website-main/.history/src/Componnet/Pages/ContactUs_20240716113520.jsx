...
const ContactUs = () => {
  return (
    <div className=' bg-gradient-to-b from-yellow-100 via-white to-yellow-100 p-4 md:p-12'>
      ...
      <h1 className="text-5xl font-bold text-black pl-56 flex flex-col">Get in touch</h1>
      <p className="mt-4 text-base flex flex-col">

        Feel free to contact DK Group for inquiries or assistance

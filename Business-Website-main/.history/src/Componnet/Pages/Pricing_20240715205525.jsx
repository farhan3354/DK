  ...
  return (
    <div className='flex items-center justify-center bg-gradient-to-b from-yellow-100 via-white to-yellow-100'>
      <div className="text-center">
        ...
        <p className="mb-4">
          DK Group offers competitive pricing structures tailored<br/>  to client needs,ensuring affordability and value across its comprehensive<br/>  range of financial services.
        </p>

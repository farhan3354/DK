  ...
  return (
    <div className='flex flex-col items-center bg-gradient-to-b from-yellow-100 via-white to-yellow-100'>
      ...
      <div className="flex items-center justify-center my-8 max-w-4xl mx-auto">
        ...
        <img src="https://dkgroup.pk/wp-content/uploads/2024/04/samson-ZGjbiukp_-A-unsplash-1024x683.jpg" alt="Investment Image" className="w-1/3 rounded-lg ml-4 h-60 w-60" />
      </div>
    </div>
  );
};

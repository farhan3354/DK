    ...
    <div className='flex flex-col items-center bg-gradient-to-b from-yellow-100 via-white to-yellow-100'>
      ...
      <div className="flex items-center justify-center my-8 max-w-4xl mx-auto">
        <div className="flex-1">
          <h2 className="text-5xl font-bold m-4 text-ye">Plan Features</h2>
        ...
        <img src="https://dkgroup.pk/wp-content/uploads/2024/04/samson-ZGjbiukp_-A-unsplash-1024x683.jpg" alt="Investment Image" className="w-1/2  ml-4 " />
      </div>
    </div>
  );
};

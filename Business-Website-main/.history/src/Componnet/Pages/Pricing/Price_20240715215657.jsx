      ...
      <div className="flex flex-1 max-w-screen-xl mx-auto space-y-6">
        <div className="flex-1">
          <div className="bg-yellow-500 text-white rounded-lg shadow-md p-6">
            ...
            <p className="mb-4">
              Get a steady return on your<br/> investment with our Basic Plan.
            </p>
        ...
        <div className="flex-1">
          <div className="bg-yellow-500 text-white rounded-lg shadow-md p-6">
            ...
            <p className="mb-4">
              Earn more with our Pro Plan, <br/>where returns are based on a
              percentage.
            </p>
            <h3 className="text-xl font-bold mb-2">Features</h3>
            <ul className="list-disc pl-6 mb-4">
            ...
            <button className="bg-white text-yellow-500 hover:bg-yellow-400 py-2 px-4 rounded-lg justify-center">
              Let's Start
            </button>
          </div>
        </div>
        <div className="flex-1">
          <div className="bg-yellow-500 text-white rounded-lg shadow-md p-6">
            ...
            <button className="bg-white text-yellow-500 rounded-lg p-3 justify-center ">
              Let's Start
            </button>
          </div>
        </div>

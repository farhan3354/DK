      ...
      <div className="flex  ">
        <div className="flex-1">
          <div className="bg-yellow-500 text-white rounded-lg shadow-md p-6">
            <h2 className=" bg-black text-yellow-500 hover:bg-yellow-400 py-2 px-4 rounded-lg w-32">BASIC</h2>
            ...
            <button className="bg-black text-yellow-500 hover:bg-yellow-400 py-2 px-4 rounded-lg w-32">
              Let's Start
            </button>
          </div>
        </div>
        <div className="flex-1">
          <div className="bg-yellow-500 text-white rounded-lg shadow-md p-6">
            <h2 className="bg-black text-yellow-500 hover:bg-yellow-400 py-2 px-4 rounded-lg w-32">PRO</h2>
            ...
            <button className="bg-black text-yellow-500  py-2 px-4 rounded-lg w-32">
              Let's Start
            </button>
          </div>
        </div>
        <div className="flex-1">
          <div className="bg-yellow-500 text-white rounded-lg shadow-md p-6">
            <h2 className="bg-black text-yellow-500 py-2 px-4 rounded-lg w-32">EXPERT</h2>
            ...
            <button className="bg-black text-yellow-500 rounded-lg p-2 w-32 m-3 ">
              Let's Start
            </button>
          </div>
        </div>

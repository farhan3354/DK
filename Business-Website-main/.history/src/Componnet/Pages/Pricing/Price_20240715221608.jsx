    ...
    <div className="items-center   m-12 gap-2">
      <div className="flex  ">
        <div className="flex-1">
          <div className="bg-black text-yellow-500 hover:bg-yellow-400 py-2 px-4 rounded-lg w-32">
            <h2 className=" font-medium p-3 bg-black rounded-sm text-yellow-500">BASIC</h2>

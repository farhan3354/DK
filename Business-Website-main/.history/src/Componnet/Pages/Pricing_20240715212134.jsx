  ...
  return (
    <div className='flex flex-col items-center  bg-gradient-to-b from-yellow-100 via-white to-yellow-100'>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <p className="text-3xl font-bold text-yellow-500 mb-2">50,000 PKR</p>
        <p className="mb-4">Get a steady return on your investment with our Basic Plan.</p>
        ...
        <button className="bg-yellow-500 hover:bg-yellow-600 text-white py-2 px-4 rounded-lg">Let's Start</button>
      </div>

      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 className="text-2xl font-bold mb-4">PRO</h2>
        <p className="text-3xl font-bold text-yellow-500 mb-2">100,000 PKR</p>
        <p className="mb-4">Earn more with our Pro Plan, where returns are based on a percentage.</p>
        <h3 className="text-xl font-bold mb-2">Features</h3>
        <ul className="list-disc pl-6 mb-4">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <p className="text-3xl font-bold text-yellow-500 mb-2">500,000 PKR</p>

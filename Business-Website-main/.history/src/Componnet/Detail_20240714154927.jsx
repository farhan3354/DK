  ...
  return (
    <div className="bg-yellow-400 flex justify-center items-center min-h-screen">
      <div className="p-4" style={{ width: '60%' }}>
        <h1 className="text-center font-bold text-xl mb-4 text-black">About DK Group</h1>
        <div className="flex flex-col items-center text-black">
          ...
          /> */}
          <h1 className="font-bold text-center mb-4">Token Harvest: Unleash Daily Gains from Idle Assets.</h1>

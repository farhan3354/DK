    ...
    return (
        <section className={`text-gray-600 body-font bg-gradient-to-b from-yellow-100 via-white to-yellow-100 opacity-100 translate-y-0`} style={{ transition: 'opacity 3s ease, transform 0.5s ease' }}>
            <div className="container mx-auto flex px-5 py-16 md:flex-row flex-col items-center md:pl-32">
                ...
                <div className="pl-52 ">
                    <img className="object-cover object-center rounded-lg vl-" alt="hero" src="https://dkgroup.pk/wp-content/uploads/2024/03/image-removebg-preview__2_-removebg-preview.png" />
                </div>
            </div>
        </section>
    );

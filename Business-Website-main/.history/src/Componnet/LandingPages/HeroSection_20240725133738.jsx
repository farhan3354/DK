        ...
        <section className="text-gray-600 body-font bg-gradient-to-b from-yellow-300 via-white to-yellow-100 opacity-100">
            <div className="container mx-auto flex flex-col md:flex-row px-5 py-16 items-center md:items-start">
                <div className="hero-content md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left mb-12 md:mb-0">
                    ...
                    <p className="mb-8 text-black text-base sm:text-lg md:text-xl leading-relaxed transition-all duration-500">
            ...
            <div className="flex justify-center mt-8 px-5">
                <img className="w-full md:w-2/3 lg:w-1/2" src="https://dkgroup.pk/wp-content/uploads/2024/03/Screenshot_2024-02-29_at_17-17-52_funnel.pdf-removebg-preview.png" alt="Project Image" />
            </div>
        </section>
    );
}

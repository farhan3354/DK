  ...
  return (
    <div className='bg-yellow-500 p-6 md:p-12 flex flex-col md:flex-row items-center'>
      <div className='md:w-1/2 md:pr-12'>
        <h1 className='font-bold text-3xl mb-4 md:mb-8 text-center md:text-left'>Token Harvest Unleash Daily Gains <br/>
          from Idle Assets</h1>
        <p className='mb-4 md:mb-8 max-w-lg mx-auto md:mx-0 text-center md:text-left'>
      ...
      <img className='w-full md:w-96 h-auto mx-auto md:ml-auto rounded-xl mt-6 md:mt-0' src="https://dkgroup.pk/wp-content/uploads/2024/03/black-1536x1025.png" alt="img" />
    </div>
  );
}

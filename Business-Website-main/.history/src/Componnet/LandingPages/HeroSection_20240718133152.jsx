...
const HeroSection = () => {
    return (
        <section className={`text-gray-600 body-font bg-yellow-500 opacity-100 translate-y-0`} style={{ transition: 'opacity 3s ease, transform 0.5s ease' }}>
            <div className="container mx-auto flex px-5 py-16 md:flex-row flex-col items-center md:pl-32">
                ...
                <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 p-24">

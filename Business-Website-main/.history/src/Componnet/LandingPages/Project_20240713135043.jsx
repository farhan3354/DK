...
const Project = () => {
  ...
  return (
    <div className="slideshow-container flex justify-center items-center">
      <div className="bg-amber-100 flex justify-center items-center"> <img className="max-w-xs  max-h-100%"  // Adjusted max-h-4/5 for 20% height decrease src="https://dkgroup.pk/wp-content/uploads/2024/03/Screenshot_2024-02-29_at_17-17-52_funnel.pdf-removebg-preview.png" alt="Project Image" /> </div>

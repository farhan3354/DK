...
const Project = () => {
  ...
  return (
    <div className="flex justify-center items-center bg-white py-4 mt-44 ml-20 mr-20 ">
          ...
          <div className="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            {projects
              ...
              .map((project, index) => (
                ...
                >
                  <div className="border-2 border-yellow-500 border-3 border-opacity-60 rounded-xl overflow-hidden bg-white flex flex-col h-full">
                    <img
                      className="w-full h-52 object-cover object-center border-5 border-yellow-500"
                      src={project.img}
                      alt={project.title}
                    />

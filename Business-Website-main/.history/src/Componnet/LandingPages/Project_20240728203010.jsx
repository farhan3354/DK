...
const Project = () => {
  ...
  return (
    <div className="flex justify-center items-center bg-white py-4 mt-12 md:mt-52 mx-4 md:mx-20">
                ...
                >
                  <div className="border-2 border-yellow-500 border-3 border-opacity-60 rounded-xl overflow-hidden bg-white flex flex-col h-full">
                    ...
                    <div className="flex flex-col flex-grow p-4 text-center">
                      <h1 className="text-2xl font-semibold black mb-2">{project.title}</h1>

  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 m-2 sm:m-4 lg:m-0 bg-yellow-100 shadow-lg rounded-lg">
      <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 text-center">
        <a href="https://search.yahoo.com/search;_ylt=AwrFRxfpGKJmcAQAIstXNyoA;_ylc=--?p=IBM+Intraday+Stock+Data&fr=mcafee&type=E210US91215G0&fr2=p%3As%2Cv%3Aw%2Cm%3Asa%2Csa_mk%3A13&iscqry=&mkr=13">IBM Intraday Stock Data</a>
      </h1>

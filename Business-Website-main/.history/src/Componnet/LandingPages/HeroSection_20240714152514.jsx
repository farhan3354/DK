...
const HeroSection = () => {
    ...
    return (
        <section className={`text-gray-600 body-font bg-yellow-400 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`} style={{ transition: 'opacity 3s ease, transform 0.5s ease' }}>

    ...
    <div className='bg-white flex flex-col items-center'>
      ...
      <div className='max-w-4xl text-center p-4 mt-16'>
        ...
        <p className='text-sm mb-8'>
          Looking ahead, DK Recruitment has ambitious goals aimed at expanding ts reach and<br/> impact within the remote work ecosystem. The company plans to forge strategic <br/>partnerships with remote-friendly companies, enhance its technological <br/>infrastructure for streamlined recruitment processes, and provide<br/> additional resources for remote job seekers to enhance <br/>their skills and employability. By staying agile and <br/>responsive to market dynamics, DK Recruitment <br/>aims to be a trusted partner for remote <br/>talent acquisition and <br/>career advancement.
        </p>
      </div>
    </div>
  );

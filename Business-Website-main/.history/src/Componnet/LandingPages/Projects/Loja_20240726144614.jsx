...
const Loja = () => {
  ...
  return (
    <div className='bg-white flex flex-col justify-center items-center min-h-screen'>
      ...
      <div>
      <button
        className=' bg-yellow-500 text-white pt-2 pb-2 p-8 pr-8 rounded-lg shadow-lg hover:bg-yellow-600'>
      <a href='/'><h1 className='font-serif text-black'>Learn More</h1></a>  

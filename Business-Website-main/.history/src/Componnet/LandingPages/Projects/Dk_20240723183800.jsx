...
const Dk = () => {
  ...
  return (
    <div className='bg-gradient-to-b from-yellow-100 via-white to-yellow-100 flex flex-col items-center'>
      ...
      <div className='max-w-4xl text-center p-4 mt-16 bg-white border border-gray-200 rounded-lg shadow-md'>
        <h2 className='text-2xl font-bold mb-4'>Social Swirl Learning Through Innovative E-Learning Solutions</h2>
        <p className='text-sm'>

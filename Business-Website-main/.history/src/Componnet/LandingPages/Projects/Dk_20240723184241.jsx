  ...
  return (
    <div className='bg-gradient-to-b from-yellow-100 via-white to-yellow-100 flex flex-col items-center'>
      ...
      <div className='max-w-4xl text-center p-4 mt-16'>
        ...
        <p className='text-sm'>
        Looking ahead, DK Recruitment has ambitious goals aimed at expanding its reach and <br/>impact within the remote work ecosystem. The company plans to forge <br/>strategic partnerships with remote-friendly companies<br/>, enhance its technological infrastructure for streamlined <br/>recruitment processes, and provide additional resources for remote job seekers to enhance their skills and employability. By staying agile and responsive to market dynamics, DK Recruitment aims to be a trusted partner for remote talent acquisition and career advancement.
        </p>
      </div>
    </div>
  );

...
const projects = [
  ...
  },
  {
    ...
    alt: "Project Image",
    txt: "Services",
    text: "Gotrolley prides itself on its diverse product portfolio, which includes:

Protective Cases: Stylish and durable cases designed to safeguard mobile devices from scratches, drops, and other daily wear and tear.

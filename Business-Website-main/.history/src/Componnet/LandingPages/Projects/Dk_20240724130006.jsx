    ...
    >
      {index % 2 === 0 ? (
        <>
          ...
          />
          <div className='flex flex-col items-start md:items-center md:ml-4 pl-20'>
        ...
        <>
          <div className='flex flex-col items-start md:items-center md:ml-4 pr-20'>
            <h1 className='font-bold text-2xl mb-3'>{project.txt}</h1>
            <p className='text-sm'>{project.text}</p>
          </div>
          <img 

...
const LocationsSection = () => (
  <div className='bg-gray-100 p-8 mt-16'>
    ...
    <div className='flex justify-center'>
      <img
        src="https://cdn.pixabay.com/photo/2016/11/29/09/08/italy-1867382_1280.jpg" // Replace with location image
        alt="Location"
...
const Loja = () => {
  ...
  return (
    <div className='bg-white flex flex-col items-center'>
      {/* Logo Section */}
      <div className='w-full text-center p-4 bg-yellow-500'>
        <img
          src="https://yourlogo.com/logo.png" // Replace with your logo URL
          alt="Logo"
      ...
      {/* Main Content */}
      <div className='text-center max-w-4xl flex flex-col items-center p-4'>
        <motion.h1
        ...
        {/* Button Section */}
        <a href="#more-info" className='mt-8 px-6 py-2 bg-yellow-500 text-white font-bold rounded-lg shadow-md'>
          More Information
        </a>
      </div>

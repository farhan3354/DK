...
const projects = [
  ...
  },
  {
    ...
    alt: "Project Image",
    txt: "Product",
    text: "LOJA product offerings span across various categories, ensuring that every customer finds something appealing and suitable for their wardrobe. Here are some of the key product lines.

Men Fashion: From smart casual wear to formal attire and accessories, LOJA offers a comprehensive range of clothing options for men, including shirts, trousers, jackets, suits, ties and more.

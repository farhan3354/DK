      ...
      {index % 2 === 0 ? (
        <>
          <img 
            src={project.src} 
            alt={project.alt} 
            className='w-full md:w-1/2 h-auto mb-16 md:mb-0 rounded-tl-full rounded-br-2xl' 
          />
        ...
        <>
          ...
          <img 
            src={project.src} 
            alt={project.alt} 
            className='w-full md:w-1/2 h-auto mb-16 md:mb-0 rounded-tl-2xl  rounded-br-2xl' 
          />
        </>
      )}
    </motion.div>

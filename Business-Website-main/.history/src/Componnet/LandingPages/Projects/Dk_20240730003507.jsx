...
import p6 from '../../../assets/DkRec.jfif'
  ...
  return (
    <div className='bg-white flex flex-col items-center'>
      <div className='text-center max-w-4xl flex flex-col items-center'>
        <div className='flex items-center mb-12 border rounded-xl'>
          <motion.img
      ...
      <div className='max-w-4xl text-center p-4 mt-16'>
        ...
        <button className='bg-yellow-500 text-black items-center pt-3 pb-3 pl-8 pr-8 text-xl font-semibold rounded-xl'>
          <a href="/">Learn More</a>
        </button>
      </div>

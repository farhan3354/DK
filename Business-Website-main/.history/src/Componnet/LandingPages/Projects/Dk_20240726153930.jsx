...
const projects = [
  ...
  {
    src: "blob:https://web.whatsapp.com/c76b4cd7-96a3-43d8-b119-dfb9e4c93f0a",
    alt: "Project Image",
    txt: "Aim",
  ...
  return (
    <div className='bg-white flex flex-col items-center'>
      ...
      <div className='max-w-4xl text-center p-4 mt-16'>
        ...
        <button className='bg-yellow-500 text-black items-center pt-3 pb-3 pl-8 pr-8 text-xl font-semibold rounded'>
          <a href="/">Learn More</a>
        </button>
      </div>

    ...
    <div>
      <section className="text-black body-font opacity-100 translate-y-0 transition-opacity duration-300 ease-in-out transform transition-transform duration-500 ease-in-out">
        <div className="container mx-auto flex flex-col md:flex-row px-5 py-16 items-center md:items-start">
          <div className="hero-content md:pl-20 flex flex-col md:items-start items-center text-center md:text-left">
          ...
          <div className="flex flex-col items-center justify-center mt-8 md:mt-0 md:ml-16">
            <img className="object-cover object-center rounded-lg mb-4 w-full max-w-sm" alt="hero" src={p1} />
          </div>
        </div>
      </section>

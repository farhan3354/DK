...
const Comment = () => {
  ...
  return (
    <div className="flex flex-wrap justify-center bg-gradient-to-b from-yellow-100 via-white to-yellow-100 bg-gradient-to-b from-yellow-100 via-white to-yellow-100">
      {comments
        .slice(currentSet * slidesPerPage, (currentSet + 1) * slidesPerPage)
        .map(comment => (
          <div key={comment.id} className="flex flex-col items-center w-full sm:w-64 md:w-80 p-4 m-2 rounded-lg shadow-md border-2 border-yellow-500">

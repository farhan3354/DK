  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 m-2 sm:m-4 lg:m-20 bg-white shadow-lg rounded-lg">
      ...
      <div className="mb-4 flex flex-wrap justify-center gap-2">
        ...
        <button className="px- py-2 bg-yellow-500 text-black rounded-md text-sm sm:text-base transition-colors duration-300" onClick={() => setTimeRange('1m')}>1 Month</button>
      </div>
      <div className="mb-8">

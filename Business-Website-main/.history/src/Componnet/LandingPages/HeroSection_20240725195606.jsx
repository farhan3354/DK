...
const HeroSection = () => {
    return (
        <section className="text-gray-600 body-font bg-white opacity-100 translate-y-0 transition-opacity duration-300 ease-in-out transform transition-transform duration-500 ease-in-out">
            <div className="container mx-auto flex flex-col md:flex-row px-5 py-16 md:pl-32 items-start absolute">
            ...
            <div className="bg-white relative top-96">
                <div className="flex justify-center items-start w-36"> {/* Adjusted to align the content to the top */}
                    <img
                        className="pl-50 "

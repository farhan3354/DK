                        ...
                        .map((project, index) => (
                            <div key={index} className="bg-gray-200 rounded-lg overflow-hidden shadow-lg">
                                <div className="relative flex justify-center items-center ">
                                    <div className="overflow-hidden rounded-full w-80 h-80 flex items-center justify-center p-8 bg-yellow-500">
                                        <img
                                ...
                                <div className="p-5 text-center ">
                                    <h3 className="text-xl font-semibold mt-2">{project.title111}</h3>
                                    <p className="text-sm mt-2">{project.description}</p>
                                    <button className="bg-yellow-500 text-white py-2 px-4 rounded-2xl hover:bg-yellow-600 focus:outline-none focus:bg-yellow-600 mt-4 transition duration-300">View Profile</button>
                                </div>
                            </div>
                        ))}
                </div>

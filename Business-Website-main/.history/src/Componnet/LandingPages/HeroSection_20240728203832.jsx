...
const HeroSection = () => {
    return (
        <div>
            <section className="text-black body-font  opacity-100 translate-y-0 transition-opacity duration-300 ease-in-out transform transition-transform duration-500 ease-in-out absolute">
                <div className="container mx-auto flex flex-col md:flex-row px-5 py-16 md:pl-32 items-start ">
                    <div className="hero-content pl-20  ">
            ...
            <div className="flex justify-center items-start relative top-56  right-6"> {/* Adjusted to align the content to the top */}
                <img
                    className="pl-50 w-2/4"
                    src={p2}
                    alt="Project Image"
                />
            </div>

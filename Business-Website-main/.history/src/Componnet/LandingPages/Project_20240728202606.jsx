...
const Project = () => {
  ...
  return (
    <div className="flex justify-center items-center bg-white py-4 mt-12 md:mt-20 ml-4 md:ml-20 mr-4 md:mr-20 mt-32">
          ...
          <div className="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            {projects
              ...
              .map((project, index) => (
                ...
                >
                  <div className="border-2 border-yellow-500 border-opacity-60 rounded-xl overflow-hidden bg-white flex flex-col h-full">
                    <img
                    ...
                    <div className="flex flex-col flex-grow p-4 text-center">
                      <h1 className="text-2xl font-semibold text-black mb-2">{project.title}</h1>

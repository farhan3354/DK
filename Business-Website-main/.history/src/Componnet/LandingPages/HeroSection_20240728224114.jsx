            ...
            <section className="text-black body-font opacity-100 translate-y-0 transition-opacity duration-300 ease-in-out transform transition-transform duration-500 ease-in-out relative w-full">
                <div className="container mx-auto flex flex-col md:flex-row px-5 py-16 md:pl-32 items-start">
                    ...
                    <div className="flex flex-col items-center justify-center mt-8 md:mt-0 ml-0 md:ml-64 w-full md:w-auto">
                        <img className="object-cover object-center rounded-lg w-full md:w-auto max-w-xs sm:max-w-sm md:max-w-full mt-32" alt="hero" src={p1} />
                    </div>
                </div>
            </section>
            <div className="flex justify-center items-start relative md:mt-0 md:top-0 md:right-0 -mt-40 md:-mt-20">
                <img className="w-full md:w-2/4 px-4 md:px-0 max-w-xs sm:max-w-sm md:max-w-full" src={p2} alt="Project Image" />
            </div>
        </div>
    );
}

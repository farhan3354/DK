                        ...
                        .map((project, index) => (
                            <div key={index} className="bg-white rounded-lg overflow-hidden shadow-lg">
                                ...
                                <div className="p-4 text-center">
                                    ...
                                    <button className="bg-yellow-100 text-white py-2 px-4 rounded-md hover:bg-yellow-600 focus:outline-none focus:bg-blue-600 mt-4 transition duration-300">View Profile</button>
                                </div>
                            </div>
                        ))}
                </div>

...
const Stock = () => {
  ...
  const times = Object.keys(timeSeries).reverse(); // Reversed for recent data at the start
  ...
  const latestTime = filteredTimes[0]; // Get the most recent time
  ...
  const chartData = {
    ...
    datasets: [
      {
        label: 'Open Price',
        data: [parseFloat(latestData['1. open']) || 0],
        fill: false,
      ...
      {
        label: 'High Price',
        data: [parseFloat(latestData['2. high']) || 0],
        fill: false,
      ...
      {
        label: 'Low Price',
        data: [parseFloat(latestData['3. low']) || 0],
        fill: false,
      ...
      {
        label: 'Close Price',
        data: [parseFloat(latestData['4. close']) || 0],
        fill: false,

  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mb-4 flex justify-center">
        <button className="mx-2 px-4 py-2 bg-black text-white rounded" onClick={() => setTimeRange('1d')}>1 Day</button>
        <button className="mx-2 px-4 py-2 bg-black-500 text-white rounded" onClick={() => setTimeRange('1w')}>1 Week</button>
        <button className="mx-2 px-4 py-2 bg-black-500 text-white rounded" onClick={() => setTimeRange('15d')}>15 Days</button>
        <button className="mx-2 px-4 py-2 bg-black-500 text-white rounded" onClick={() => setTimeRange('1m')}>1 Month</button>
        <button className="mx-2 px-4 py-2 bg-black-500 text-white rounded" onClick={() => setTimeRange('1y')}>1 Year</button>
      </div>
      <div className="mb-8">

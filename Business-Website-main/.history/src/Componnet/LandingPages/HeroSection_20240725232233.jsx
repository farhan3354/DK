...
const HeroSection = () => {
    return (
        <div>
            <section className="text-gray-600 body-font bg-white opacity-100 translate-y-0 transition-opacity duration-300 ease-in-out transform transition-transform duration-500 ease-in-out relative">
                <div className="container mx-auto flex flex-col md:flex-row px-5 py-16 md:pl-32 items-start">
                    <div className="hero-content order-2 md:order-1 md:pl-20">
                        <h2 className="text-3xl sm:text-4xl md:text-5xl mb-4 font-bold text-black transition-all duration-500">
                            INVEST YOUR
                        </h2>
                        <h1 className="text-4xl sm:text-5xl md:text-6xl mb-4 font-bold text-black transition-all duration-500">
                            MONEY!
                        </h1>
                        <p className="mb-8 text-black text-lg sm:text-xl md:text-2xl leading-relaxed transition-all duration-500">
                    ...
                    <div className="flex flex-col items-center justify-center order-1 md:order-2 md:pl-72">

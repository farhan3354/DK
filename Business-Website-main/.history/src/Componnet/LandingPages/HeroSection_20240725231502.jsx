...
const HeroSection = () => {
    return (
        <div className="bg-yellow-500"> {/* Added bg-yellow-500 here */}
            <section className="text-gray-600 body-font opacity-100 translate-y-0 transition-opacity duration-300 ease-in-out transform transition-transform duration-500 ease-in-out absolute">
            ...
            <div className="flex justify-center items-start relative top-52">
                <img

        ...
        <div>
            <section className="text-black body-font opacity-100 translate-y-0 transition-opacity duration-300 ease-in-out transform transition-transform duration-500 ease-in-out absolute w-full md:flex  ">
                <div className="container mx-auto flex flex-col md:flex-row px-5 py-16 md:pl-32 items-start">
                    ...
                    <div className="flex flex-col items-center justify-center mt-8 md:mt-0 ml-0 md:ml-64 w-full md:w-auto custom-range:hidden">
                        <img className="object-cover object-center rounded-lg mb-4 w-full md:w-auto custom-range:hidden" alt="hero" src={p1} />
                    </div>
                </div>
            </section>
            <div className="flex justify-center items-start relative mt-16 md:mt-0 md:top-56 md:right-6 custom-range:top-96 custom-range:mt-52 ">

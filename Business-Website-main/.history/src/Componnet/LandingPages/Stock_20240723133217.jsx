  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 m-2 sm:m-4 lg:m-6">
      <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 text-center">
        <a href="https://search.yahoo.com/search?fr=mcafee&type=E210US91215G0&p=IBM+Intraday+Stock+Data" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">

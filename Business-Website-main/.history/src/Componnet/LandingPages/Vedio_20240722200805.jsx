...
const Vedio = () => {
  return (
    <div className='p-6 md:p-12'>
      ...
      {/* Video Information */}
      <div className=" ">
  <h1 className="font-bold text-3xl mb-4 m-6 text-center">
    DK Group Our Latest News
  </h1>
  <p className="text-lg text-center">
    Stay informed and empowered with the latest investment news <br/>
    and updates from DK Group. By staying abreast <br/>
    of market trends, <br/>
    sector developments, and economic indicators, you can <br/>
    make informed investment decisions that align with <br/>
    your financial goals and objectives. <br/>

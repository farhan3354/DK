...
const Team = () => {
    ...
    return (
        <div className="">
            <div className="container mx-auto px-4 md:px-24 my-3">
                    ...
                    {projects
                        ...
                        .map((project, index) => (
                            <div key={index} className="bg-gray-200 rounded-lg overflow-hidden shadow-lg">
                                <div className="relative flex justify-center items-center bg-yellow-500">
                                ...
                                <div className="p-5 text-center bg-yellow-400">
                                    <h3 className="text-xl font-semibold mt-2">{project.title}</h3>
                                    <p className="text-sm mt-2">{project.description}</p>
                                    <button className="bg-black text-white py-3 px-5 rounded-2xl hover:bg-yellow-600 focus:outline-none focus:bg-yellow-600 mt-4 transition duration-300">View Profile</button>
                                </div>
                            </div>
                        ))}
                </div>

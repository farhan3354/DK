...
const HeroSection = () => {
    return (
        <section className="text-gray-600 body-font bg-yellow-500 opacity-100 translate-y-0 transition-opacity duration-300 ease-in-out transform transition-transform duration-500 ease-in-out">

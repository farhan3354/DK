...
const Project = () => {
  ...
  const slidesPerPage = [1,2,3, 4, 5, 6];
  ...
  return (
    <div className="slideshow-container flex justify-center items-center bg-yellow-300 min-h-screen">
      {projects.map((project, index) => (
        <div
          key={index}
          className={`slide p-4 ${index >= currentSet * slidesPerPage[0] && index < (currentSet + 1) * slidesPerPage[0] ? '' : 'hidden'}`}
          style={{ width: `calc(100% / ${slidesPerPage[0]})` }}
        >

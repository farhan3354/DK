    ...
    <div className='p-6 md:p-12'>
      ...
      <div className='mt-8 justify-between item-center'>
        ...
        <p className='text-lg items-center'>
          Stay informed and empowered with the latest investment news <br/>and updates from DK Group. By staying abreast <br/>of market trends, <br/>sector developments, and economic indicators, you can <br/>make informed investment decisions that align with <br/>your financial goals and objectives. <br/>Trust DK Group to keep you informed and guide you on your investment journey.
        </p>
      </div>
    </div>
  );

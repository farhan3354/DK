...
const Project = () => {
  ...
  return (
    <div className="slideshow-container flex justify-center items-center bg-yellow-300 min-h-screen md:pl-32 md:pr-32">
      {projects
        ...
        .map((project, index) => (
          ...
          >
            <div className="border-2 border-gray-200 border-opacity-60 rounded-xl overflow-hidden bg-white p-">
              <img

...
const Stock = () => {
  ...
  return (
    <div className="container mx-auto p-4 sm:p-6 lg:p-8 m-14">
      <h1 className="text-2xl font-bold mb-4 text-center">IBM Intraday Stock Data</h1>
      <div className="mb-4 flex flex-wrap justify-center gap-2">
        <button className="px-4 py-2 bg-black text-white rounded-md text-sm sm:text-base" onClick={() => setTimeRange('1d')}>Today</button>
        <button className="px-4 py-2 bg-black text-white rounded-md text-sm sm:text-base" onClick={() => setTimeRange('1w')}>1 Week</button>
        <button className="px-4 py-2 bg-black text-white rounded-md text-sm sm:text-base" onClick={() => setTimeRange('15d')}>15 Days</button>
        <button className="px-4 py-2 bg-black text-white rounded-md text-sm sm:text-base" onClick={() => setTimeRange('1m')}>1 Month</button>
      </div>
      <div className="mb-8">

                        ...
                        .map((project, index) => (
                            <div key={index} className="bg-gray-200 rounded-lg overflow-hidden shadow-lg">
                                ...
                                <div className="p-5 text-center ">
                                    ...
                                    <button className="bg-blakc text-white py-2 px-4 rounded-2xl hover:bg-yellow-600 focus:outline-none focus:bg-yellow-600 mt-4 transition duration-300">View Profile</button>
                                </div>
                            </div>
                        ))}
                </div>

...
const Project = () => {
  const projects = [
    {
      ...
      category: 'CATEGORY 1',
      title: 'Project 1',
      description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla accumsan arcu fermentum, congue velit id, cursus justo usto usto usto  dolor sit amet, consectetur adipiscing elit. Nulla accumsan arcu fermentum, congue velit id, cursus justo usto usto usto.',
    },
    {
      imageUrl: 'https://dummyimage.com/720x400',
      category: 'CATEGORY 2',
  ...
  return (
    <div className="slideshow-container flex justify-center items-center bg-yellow-300" style={{ height: '60vh', paddingLeft: '32px', paddingRight: '32px' }}>
      {projects

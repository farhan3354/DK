        ...
        <header className="text-black-600 body-font">
            <div className="bg-white">
                <div className="container mx-auto px-5 md:px-32 py-4 flex flex-wrap items-center justify-between">
                    <Link to="/" className="flex title-font font-semibold text-2xl items-center text-black  mb-4 md:mb-0">
                        <img
                    ...
                    <nav className={`md:flex md:items-center md:space-x-5 text-2xl text-base mt-4 md:mt-0 ${isOpen ? 'block' : 'hidden'}`}>

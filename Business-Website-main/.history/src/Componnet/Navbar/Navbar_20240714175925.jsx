            ...
            <div className="bg-amber-100">
                <div className="container mx-auto px-5 md:px-32 py-4 flex flex-wrap items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center mt-4 md:mt-0">
                        <button className="inline-flex items-center bg-gray-100 border-0 py-2 px-4 focus:outline-none bg-yellow-500 hover:text-gray-900 rounded-xl text-base font-bold transition-colors duration-300 mr-4">

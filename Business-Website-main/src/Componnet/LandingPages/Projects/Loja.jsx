...
import p1 from '../../../assets/pr4.jpg'
import p2 from '../../../assets/t3.jpg'
import p3 from '../../../assets/a3.jpg'
import p4 from '../../../assets/p1.png'
import p5 from '../../../assets/f3.jpg'
import p6 from '../../../assets/su3.jpg'
import p7 from '../../../assets/Loja.jpeg'
import LojaP from './LojaP';
    ...
    <div className='flex flex-col items-center justify-center min-h-screen bg-white'>
      <div className='flex flex-col items-center max-w-4xl text-center'>
        <div className='flex items-center '>
          <img
            src={p7} // Replace with your logo URL
            alt="Logo"
            className='w-52 h-52 '
          />
          {/* <motion.h1
      ...
      <div>
        <button
          className='p-8 pt-2 pb-2 pr-8 mb-6 text-white bg-yellow-500 rounded-lg shadow-lg hover:bg-yellow-600'
        >

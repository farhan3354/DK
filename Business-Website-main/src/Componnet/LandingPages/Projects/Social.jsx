...
import p3 from '../../../assets/se1.jpg';
import p4 from '../../../assets/f1.jpg';
import p5 from '../../../assets/su1.jpg';
import SocialP from './SocialP';
...
const Social = ({ project, index, inView, setInView }) => {
  ...
  return (
    <div className='flex flex-col items-center'>
      <div className='max-w-4xl text-center'>
        ...
        >
          <img 
            ...
            alt="Logo"
            className="w-40 h-40 ml-8 rounded-full" 
          />
        </motion.div>
        <motion.h1
      ...
      <div className='mt-8 mb-6'>
        <button className='pt-2 pb-2 pl-8 pr-8 text-xl font-semibold text-black bg-yellow-500 rounded-lg shadow-2xl'>
          <a href='https://socialswirl.tech/'>
            <h1>Learn More</h1>
          </a>
        </button>
      </div>

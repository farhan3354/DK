...
const UserPortal = () => {
    ...
    const handleEdit = (index) => {
        ...
        setFormData({
            ...
            investmentAmount: clientToEdit.investmentAmount,
            profitAmount: clientToEdit.profitAmount
        });
    ...
    <form onSubmit={handleSubmit} className="mt-8">
        ...
        <div className="flex flex-wrap mb-5 -mx-3">
            ...
            <div className="w-full px-3 sm:w-1/2">
                <label htmlFor="pdfFile" className="block mb-3 text-base font-medium text-gray-700">
                    Upload PDF
                </label>
                <input
                    type="file"
        ...
        {/* Investment and Profit Amount Input */}
        <div className="flex flex-wrap mb-5 -mx-3">
            <div className="w-full px-3 sm:w-1/2">
                <label htmlFor="investmentAmount" className="block mb-3 text-base font-medium text-gray-700">
                    Investment Amount
                </label>
                <input
                    type="number"
            ...
            <div className="w-full px-3 sm:w-1/2">
                <label htmlFor="profitAmount" className="block mb-3 text-base font-medium text-gray-700">
                    Profit Amount
                </label>
                <input
                    type="number"
                        ...
                        {clients.map((client, index) => (
                            <tr key={index}>
                                ...
                                <td className="px-4 py-2 border border-gray-300">
                                    {client.pdf === 'No file selected' ? 'No file' : <a href={client.pdf} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">View PDF</a>}
                                </td>
                                <td className="px-4 py-2 border border-gray-300">
                                    <button

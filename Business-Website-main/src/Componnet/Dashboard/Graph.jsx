...
const ProductSales = () => {
  ...
  return (
    <div className="antialiased text-black sans-serif">
      <div className="px-4">
        <div className="max-w-xl py-24 mx-auto"> {/* Increased width */}
          <div className="p-6 rounded-lg shadow">
            ...
            <div className="flex gap-2">
              <button onClick={() => setChartType('Bar')} className="flex items-center px-4 py-2 space-x-2 text-white bg-blue-500 rounded-lg">
                <FaChartBar />
                <span>Bar</span>
              </button>
              <button onClick={() => setChartType('Line')} className="flex items-center px-4 py-2 space-x-2 text-white bg-green-500 rounded-lg">
                <FaChartLine />
                <span>Line</span>
              </button>
              <button onClick={() => setChartType('Doughnut')} className="flex items-center px-4 py-2 space-x-2 text-white bg-orange-500 rounded-lg">
                <BiDoughnutChart />
                <span>Doughnut</span>
              </button>
              <button onClick={() => setChartType('Polar')} className="flex items-center px-4 py-2 space-x-2 text-white bg-red-500 rounded-lg">
                <FaChartPie />
                <span>Polar</span>
              </button>
              <button onClick={() => setChartType('Radar')} className="flex items-center px-4 py-2 space-x-2 text-white bg-purple-500 rounded-lg">
                <FaChartArea />
                <span>Radar</span>
              </button>
            </div>
